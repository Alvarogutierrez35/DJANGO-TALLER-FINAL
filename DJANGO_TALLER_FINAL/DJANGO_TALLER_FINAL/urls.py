...
urlpatterns = [
    ...
    path ('', views.index),
    path('listadoinscritos/', views.lista_inscrito),
    path('agregarinscrito/', views.agregar_inscrito),
    path('eliminarinscrito/<int:id>/', views.eliminar_inscrito),
    path('actualizarinscrito/<int:id>/', views.actualizar_inscrito),
