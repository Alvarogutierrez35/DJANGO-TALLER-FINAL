...
def crud(request):
    return render(request, 'listadoinscritos.html', {})
...
def lista_inscrito(request):
    ...
    return render(request, 'listadoinscritos.html', data)
...
def eliminar_inscrito(request, id):
    ...
    inscri.delete()
    return redirect('/listadoinscritos')
...
def actualizar_inscrito(request, id):
    ...
    if request.method == 'POST':
        ...
        return redirect('/listadoinscritos')
    data = {'form' : form}
    return render(request, 'actualizarinscrito.html', data)
